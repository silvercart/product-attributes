...
<div class="modal fade <% if $CurrentPage.ShowChooseGlobalProductAttributesModal %>show-on-page-load<% end_if %>" id="modal-choose-product-attribute" tabindex="-1" role="dialog" aria-hidden="true" data-allow-multiple-choice="{$AllowMultipleChoice}">
